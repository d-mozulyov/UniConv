...
function ansi_from_ansi_uniconv(const Source: IsoLatinString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: LatinString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_sbcs_upper(AnsiString(Destination), AnsiString(Source), CODEPAGE_LATIN);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_sbcs(AnsiString(Destination), AnsiString(Source), CODEPAGE_LATIN);
  end;
...
function ansi_from_utf16_uniconv(const Source: UnicodeString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: LatinString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_utf16_upper(AnsiString(Destination), Source, CODEPAGE_LATIN);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_utf16(AnsiString(Destination), Source, CODEPAGE_LATIN);
  end;
...
function ansi_from_utf8_uniconv(const Source: UTF8String; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: LatinString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_utf8_upper(AnsiString(Destination), Source, CODEPAGE_LATIN);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.sbcs_from_utf8(AnsiString(Destination), Source, CODEPAGE_LATIN);
  end;
...
function utf16_from_ansi_uniconv(const Source: IsoLatinString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UnicodeString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf16_from_sbcs_upper(Destination, AnsiString(Source));
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf16_from_sbcs(Destination, AnsiString(Source));
  end;
...
function utf16_from_utf16_uniconv(const Source: UnicodeString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UnicodeString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf16_from_utf16_upper(Destination, Source);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    Destination := Source;
...
function utf16_from_utf8_uniconv(const Source: UTF8String; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UnicodeString;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf16_from_utf8_upper(Destination, Source);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf16_from_utf8(Destination, Source);
  end;
...
function utf8_from_ansi_uniconv(const Source: IsoLatinString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UTF8String;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf8_from_sbcs_upper(Destination, AnsiString(Source));
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf8_from_sbcs(Destination, AnsiString(Source));
  end;
...
function utf8_from_utf16_uniconv(const Source: UnicodeString; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UTF8String;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf8_from_utf16_upper(Destination, Source);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
	UniConv.utf8_from_utf16(Destination, Source);
  end;
...
function utf8_from_utf8_uniconv(const Source: UTF8String; const UpperCase: Boolean): Integer;
var
  i: Integer;
  Destination: UTF8String;
begin
  ...
  begin
    for i := 1 to ITERATIONS_COUNT do
    UniConv.utf8_from_utf8_upper(Destination, Source);
  end else
  begin
    for i := 1 to ITERATIONS_COUNT do
    Destination := Source;
...
procedure RunTest(const DestinationEncoding, SourceEncoding: string;
  const Source; const ProcStandard, ProcUniConv: Pointer;
...
begin
  ...
  begin
    ...
    Time := GetTickCount;
    TTestProc(ProcUniConv)(Pointer(Source), UpperCase);
    Time := GetTickCount - Time;
    Writeln(Time, 'ms');
  end;
end;
...
begin
  try
    Writeln('The benchmark shows how you can use convert functions of UniConv library');
